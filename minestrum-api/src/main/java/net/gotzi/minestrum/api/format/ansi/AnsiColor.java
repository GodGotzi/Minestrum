...
package net.gotzi.minestrum.api.format.ansi;
...
public class AnsiColor {
    ...
    public static String PINK = "\033[0;38m";

    public static final String[] colorArray = new String[]{RED, GREEN, YELLOW, BLUE, PURPLE, CYAN, WHITE, PINK};
    ...
    public static void turnOffColours() {
        BLACK = "";   // BLACK
        RED = "";     // RED
        GREEN = "";   // GREEN
        YELLOW = "";  // YELLOW
    ...
    /**
     * It removes all ANSI color codes from a string
     *
     * @param str The string to remove the colors from.
