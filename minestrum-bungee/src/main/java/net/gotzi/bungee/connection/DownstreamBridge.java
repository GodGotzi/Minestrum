...
import net.gotzi.bungee.api.event.ServerDisconnectEvent;
import net.gotzi.bungee.api.event.TabCompleteResponseEvent;
import net.gotzi.bungee.api.plugin.Command;
import net.gotzi.bungee.api.score.Objective;
import net.gotzi.bungee.api.score.Position;
...
public class DownstreamBridge extends PacketHandler
{
    ...
    public void handle(KeepAlive alive) throws Exception
    {
        ...
        {
            server.getKeepAlives().add( new ServerConnection.KeepAliveData( alive.getRandomId(), System.currentTimeMillis() ) );
        }
    }
    ...
    @Override
    public void handle(net.gotzi.bungee.protocol.packet.Team team) throws Exception
    {
        Scoreboard serverScoreboard = con.getServerSentScoreboard();
        ...
        net.gotzi.bungee.api.score.Team t;
        if ( team.getMode() == 0 )
        {
            t = new net.gotzi.bungee.api.score.Team( team.getName() );
