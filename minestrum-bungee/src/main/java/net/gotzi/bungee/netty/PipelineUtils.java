...
import net.gotzi.bungee.api.event.ClientConnectEvent;
import net.gotzi.bungee.protocol.KickStringWriter;
import net.gotzi.bungee.protocol.LegacyDecoder;
...
import net.gotzi.bungee.protocol.Varint21FrameDecoder;
import net.gotzi.bungee.protocol.Varint21LengthFieldPrepender;
