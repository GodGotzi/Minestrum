...
import net.gotzi.minestrum.api.event.ChatEvent;
import net.gotzi.minestrum.api.event.PlayerDisconnectEvent;
import net.gotzi.minestrum.api.event.PluginMessageEvent;
import net.gotzi.minestrum.api.event.SettingsChangedEvent;
import net.gotzi.minestrum.api.event.TabCompleteEvent;
