...
import net.gotzi.minestrum.ServerConnection;
import net.gotzi.minestrum.ServerConnection.KeepAliveData;
...
import net.gotzi.minestrum.api.event.PluginMessageEvent;
import net.gotzi.minestrum.api.event.ServerConnectEvent;
import net.gotzi.minestrum.api.event.ServerDisconnectEvent;
import net.gotzi.minestrum.api.event.ServerKickEvent;
import net.gotzi.minestrum.api.event.TabCompleteResponseEvent;
import net.gotzi.minestrum.api.plugin.Command;
import net.gotzi.minestrum.api.score.Objective;
import net.gotzi.minestrum.api.score.Position;
...
import net.gotzi.minestrum.entitymap.EntityMap;
...
import net.gotzi.minestrum.tab.TabList;
...
public class DownstreamBridge extends PacketHandler
{
    ...
    @Override
    public void handle(net.gotzi.minestrum.protocol.packet.Team team) throws Exception
    {
        Scoreboard serverScoreboard = con.getServerSentScoreboard();
    ...
    public void handle(TabCompleteResponse tabCompleteResponse) throws Exception
    {
        ...
        if ( commands == null )
        {
            commands = Lists.transform( tabCompleteResponse.getSuggestions().getList(), input -> input.getText());
        }
        ...
        if ( !bungee.getPluginManager().callEvent( tabCompleteResponseEvent ).isCancelled() )
        {
            ...
            if ( !commands.equals( tabCompleteResponseEvent.getSuggestions() ) )
            {
                ...
                } else
                {
                    ...
                    tabCompleteResponse.setSuggestions( new Suggestions( range, Lists.transform( tabCompleteResponseEvent.getSuggestions(),
                            input -> new Suggestion(range, input)) ) );
                }
            }
