...
import net.gotzi.minestrum.api.event.ClientConnectEvent;
import net.gotzi.minestrum.protocol.KickStringWriter;
import net.gotzi.minestrum.protocol.LegacyDecoder;
...
import net.gotzi.minestrum.protocol.Varint21FrameDecoder;
import net.gotzi.minestrum.protocol.Varint21LengthFieldPrepender;

public class PipelineUtils
{

    public static final AttributeKey<ListenerInfo> LISTENER = AttributeKey.valueOf( "ListerInfo" );
    public static final ChannelInitializer<Channel> SERVER_CHILD = new ChannelInitializer<>() {
        @Override
